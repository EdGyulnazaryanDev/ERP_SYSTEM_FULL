export declare enum BrainStepType {
...
export declare enum BrainStepStatus {
    PENDING = "PENDING",
    PENDING_APPROVAL = "PENDING_APPROVAL",
    APPROVED = "APPROVED",
    REJECTED = "REJECTED",
...
//# sourceMappingURL=brain.enum.d.ts.map