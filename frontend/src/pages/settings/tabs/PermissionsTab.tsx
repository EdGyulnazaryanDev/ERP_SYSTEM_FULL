...
export default function PermissionsTab() {
  ...
  const canCreatePermissions = canPerform('rbac', 'create');
  const canEditPermissions = canPerform('rbac', 'edit');
  const canDeletePermissions = canPerform('rbac', 'delete');
  ...
  return (
    <div>
      ...
      {/* Create/Edit Modal */}
      {(canCreatePermissions || canEditPermissions) && (
        <Modal
